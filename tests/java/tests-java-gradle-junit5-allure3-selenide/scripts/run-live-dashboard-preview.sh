...
INDEX_OUTPUT="$REPO_ROOT/tests-java-gradle-junit5-allure3-selenide/build/analytics-index.json"
POLL_MS=300
INTERVAL_MS=""
STEPS=8
...
ln -sfn ../tests-java-gradle-junit5-allure3-selenide/build/analytics-index.json "$FRONTEND_DIR/analytics-index.json"
