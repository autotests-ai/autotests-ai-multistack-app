...
| integration / api / e2e / manual | `integration-tests` · `api-tests` · `e2e-smoke` · `e2e-tests` / `manual-tests` | `tests/java/…/tests/integration/` · `tests/api/` · `tests/e2e/` · manual stubs **in code** (`tests/manual/`) |
