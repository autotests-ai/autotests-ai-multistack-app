...
| integration / api / e2e / manual | `integration-tests` · `api-tests` · `e2e-mock-tests` · `e2e-tests` / `manual-tests` | `tests/java/…/tests/integration/` · `tests/api/` · `tests/e2e/` · manual stubs **in code** (`tests/manual/`) |
