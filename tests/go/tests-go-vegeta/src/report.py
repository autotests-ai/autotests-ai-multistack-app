"""Build Vegeta HTML + k6-shaped summary.json from vegeta encode JSONL."""
...
<body>
  <h1>Vegeta</h1>
  <p class="meta">tsenart/vegeta JSONL · health → login → me → items → logout</p>
