...
| `tests-kotlin-gradle-junit5-allure3-selenium` | **active** — UI+HTTP Selenium + in-cell Ktor; JaCoCo + `sonar-tests` |
| `tests-kotlin-gradle-junit5-allure3-playwright` | **active** — UI+HTTP Playwright + in-cell Ktor; JaCoCo + `sonar-tests` |
