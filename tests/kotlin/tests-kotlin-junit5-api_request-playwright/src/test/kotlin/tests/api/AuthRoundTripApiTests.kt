...
class AuthRoundTripApiTests : ApiTestBase() {
    ...
    fun accountLifecycleRoundTrip() {
        ...
        val registered = PlaywrightHttp.request(
            "POST",
            "/api/auth/register",
        ...
        val login = PlaywrightHttp.request(
            "POST",
            "/api/auth/login",
