...
class TestBurgerMenu:
    ...
    def test_menu_nav_marks_active_login(self, login_page: LoginPage, header: HeaderComponent):
        login_page.open_page()
        header.open_menu().should_have_active_menu_nav("header-menu-nav-login")
    ...
    def test_clicking_register_opens_register_and_closes_menu(
        self, login_page: LoginPage, register_page: RegisterPage, header: HeaderComponent
    ):
        login_page.open_page()
        header.open_menu().should_have_active_menu_nav("header-menu-nav-login").click_menu_nav(
            "header-menu-nav-register"
        )
        register_page.should_be_open()
        header.should_have_closed_menu()
    ...
    def test_clicking_login_opens_login_and_closes_menu(
        ...
        header.open_menu().click_menu_nav("header-menu-nav-login")
