...
def capture_and_compare(element: WebElement, area: str, viewport: int, attachment_name: str) -> None:
    wait_for_stable_layout(element.parent)
    actual = element.screenshot_as_png
...
def wait_for_stable_layout(driver) -> None:
