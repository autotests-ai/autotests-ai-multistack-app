 ...
 * Default: ./allurerc.mjs (cwd) or ethalon _ethalon/allurerc.mjs when run from projects/autotests-ai-multistack-home/autotests-ai-multistack-app/tests/_tests-meta.
 */
