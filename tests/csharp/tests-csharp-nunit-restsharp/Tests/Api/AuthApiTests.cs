...
public sealed class AuthApiTests : ApiTestBase
{
    ...
    [Test]
    [Category("api")]
    [AllureName("POST /api/auth/register accepts a 3-character username and 6-character password")]
    ...
    [Test]
    [Category("api")]
    [AllureName("POST /api/auth/login with min-length unknown user is 401, not 400")]
