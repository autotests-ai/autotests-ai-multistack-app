...
public static class ScreenshotHelper
{
    ...
    public static void CaptureAndCompare(IWebElement element, string area, int viewport, string attachmentName)
    {
        if (element == null || !element.Displayed)
        {
            throw new AssertionException("Screenshot target is not displayed: " + area);
        }

        var actual = ((ITakesScreenshot)element).GetScreenshot().AsByteArray;
        ...
        AllureApi.Step("Compare screenshot: " + attachmentName, () =>
        {
            ...
            throw new AssertionException(comparison.Message);
        });
    }
