...
public sealed class ExploratoryManualTests : AllureMeta
{
    ...
    [Fact(DisplayName = "Auth happy path across login → home → logout")]
    ...
    [Trait("TestCategory", "manual")]
    [AllureLabel("ALLURE_MANUAL", "true")]
    [Fact(DisplayName = "Items catalogue: content, order and resilience charter")]
    ...
    [Trait("TestCategory", "manual")]
    [AllureLabel("ALLURE_MANUAL", "true")]
    [Fact(DisplayName = "Session and token edge cases charter")]
