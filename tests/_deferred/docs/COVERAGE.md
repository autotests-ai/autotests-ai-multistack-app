...
| `tests/` test-infra profile | `ConfigReader`, `LayoutCss`, `TokensCss` | **100%** | `./gradlew testInfra jacocoTestInfraCoverageVerification -Denv=reference_ci_testinfra` |
...
- `pyramid-testinfra-jacoco` — test-infra profile HTML/XML
