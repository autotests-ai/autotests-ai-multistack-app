...
Canon SSOT stays short path [`tests/`](../../tests/) ≡ **java · gradle · junit5 · selenide** (full pyramid). This cell is Selenium smoke only — same flows as [`../../tests-python-selenium/`](../../tests-python-selenium/) (`pip-pytest-selenium` shape).
...
| Suite | Mirrors |
|-------|---------|
| `HomeTests` | tests-python-selenium `test_home` |
| `LoginTests` | tests-python-selenium `test_login` |
| `RegisterTests` | tests-python-selenium `test_register` |
| `LogoutTests` | tests-python-selenium `test_logout` |
| `HeaderActiveNavTests` | tests-python-selenium `test_header_active_nav` |
