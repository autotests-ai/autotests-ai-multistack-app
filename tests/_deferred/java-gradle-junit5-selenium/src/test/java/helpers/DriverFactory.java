...
/**
 * Local Chrome for Testing (pinned) or remote Selenoid — mirrors tests-python-selenium conftest.
 */
public final class DriverFactory {
    ...
    public static WebDriver create(TestConfig config) {
        ...
        if (!config.remoteUrl().isBlank()) {
            ...
            selenoidOpts.put("name", "autotests-ai-multistack-java-gradle-junit5-selenium");
