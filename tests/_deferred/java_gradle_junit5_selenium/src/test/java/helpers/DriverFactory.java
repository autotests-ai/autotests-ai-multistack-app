...
/**
 * Local Chrome for Testing (pinned) or remote Selenoid — mirrors tests_python_selenium conftest.
 */
public final class DriverFactory {
    ...
    public static WebDriver create(TestConfig config) {
        ...
        if (!config.remoteUrl().isBlank()) {
            ...
            selenoidOpts.put("name", "reference-app-java_gradle_junit5_selenium");
