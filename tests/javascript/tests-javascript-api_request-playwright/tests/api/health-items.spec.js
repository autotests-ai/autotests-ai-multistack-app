...
test.describe('Health and items API', { tag: ['@api'] }, () => {
  test('GET /api/health matches the health contract and reports ok', async ({ request }) => {
  ...
  test('GET /api/items matches the items contract (typed rows, named source)', async ({ request }) => {
