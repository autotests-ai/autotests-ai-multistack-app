...
const I18N = {
  en: {
    ...
    reportMissing:
      "No local report yet. Run: cd tests_java_gradle && ./gradlew test && ./gradlew allureReport, then ln -sfn ../tests_java_gradle/build/reports/allure-report/allureReport allure-report",
  },
  ru: {
    ...
    reportMissing:
      "Локальный отчёт не найден. cd tests_java_gradle && ./gradlew test && ./gradlew allureReport, затем ln -sfn ../tests_java_gradle/build/reports/allure-report/allureReport allure-report",
  },
};

const DASHBOARD_CANDIDATES = [
  "allure-report/dashboard/index.html",
  "../tests_java_gradle/build/reports/allure-report/allureReport/dashboard/index.html",
];

const REPORT_CANDIDATES = [
  "allure-report/awesome/index.html",
  "../tests_java_gradle/build/reports/allure-report/allureReport/awesome/index.html",
];

const ANALYTICS_CANDIDATES = [
  "analytics-index.json",
  "allure-report/analytics-index.json",
  "../tests_java_gradle/build/analytics-index.json",
];
