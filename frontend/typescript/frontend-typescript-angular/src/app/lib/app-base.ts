...
export const UI_MOUNT = 'frontend-typescript-angular';
...
function resolveFromPathname(pathname: string) {
  ...
  // a mount-shaped base href would leave the router with nothing to match.
  return {
    backendId: null as string | null,
...
/** Router base href — trailing slash omitted. */
