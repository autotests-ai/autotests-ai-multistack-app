...
| `sync-stack-matrix.py` | deploy ports + hub `tests.modules` → `js/env-hosts.js` + inbox `projects/autotests-ai-home/stack-matrix/overlay/stack/matrix.json`; fan-out env-hosts into `vendor/ds` |
