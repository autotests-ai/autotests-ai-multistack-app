...
MANIFEST="${MANIFEST:-$MONOREPO_ROOT/projects/autotests-ai-multistack-home/autotests-ai-multistack-app/_contract/ui.manifest.yaml}"
...
for sid in screens:
    if sid not in catalog:
        raise SystemExit(f"STOP: unknown screen {sid!r} — see projects/autotests-ai-multistack-home/autotests-ai-multistack-app/_contract/ui.manifest.yaml")
    entry = catalog[sid]
